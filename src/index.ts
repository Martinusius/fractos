...
expose({ THREE, RealtimeRenderer, DepthRenderer, Raymarcher, Raytracer, Menger, Sierpinski, ColorBackground, HemisphereBackground, Mandelbulb, Queue, controls, camera });